...
<div class="flex items-center justify-center p-20 bg-white">
  <div class="col-span-12">
    <div class="overflow-auto lg:overflow-visible ">
        ...
        <h2 class="text-2xl text-gray-900 font-bold">Tabel Data Kamar</h2>
        <div class="text-center flex-auto"> </div>
        </div>
      <table class="table text-yellow-400 border-separate space-y-6 text-sm">
        <thead class="bg-yellow-500 text-white">
          <tr>
            <th class="p-3">No</th>
            <th class="p-3 text-left">Id Kamar</th>
            <th class="p-3 text-left">No Pesanan</th>
            <th class="p-3 text-left">Nama Kamar</th>
            <th class="p-3 text-left">Harga Kamar</th>
            <th class="p-3 text-left">Deskripsi Kamar</th>
            <th class="p-3 text-left">Stock Kamar</th>
        ...
        <?php
                $no = 1;
                $kamar = mysqli_query($conn, "SELECT * FROM tb_kamar ORDER BY id_kamar DESC");
            ...
            <tr class="bg-yellow-200 lg:text-black">
                ...
                <td  class="px-6 py-3 font-bold"><?php echo $row['id_kamar']?></td>
                <td  class="px-6 py-3 font-bold"><?php echo $row['no_pesanan']?></td>
                <td  class="px-6 py-3 font-bold"> <?php echo $row['nama_kamar']?></td>
                <td  class="px-6 py-3 font-bold"><?php echo $row['harga_kamar']?></td>
                <td  class="px-6 py-3 font-bold"><?php echo $row['deskripsi_kamar']?></td>
                <td  class="px-6 py-3 font-bold"><?php echo $row['stock_kamar']?></td>
                <td>
                <a href="hapus_kamar.php?idp=<?php echo $row ['id_kamar']?>" class="text-red-400 hover:text-gray-100 ml-2">
