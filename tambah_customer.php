...
<div class="bg-yellow-100 rounded-3xl mt-28 mx-12 px-5 py-12">
    <p class="text-center text-xl font-bold">Tambah Data Customer</p>
    <form action="" method="POST">
    <div class="text-center">
    <form action="" method="POST">
        <input type="text" name="no_pesanan" class="input-control" placeholder="No Pesanan" required>
        <input type="text" name="nama_customer" class="input-control" placeholder="Nama Customer" required>
        <input type="text" name="telp" class="input-control" placeholder="Telepon" required>
        <input type="text" name="produk" class="input-control" placeholder="Nama Kamar" required>
        <input type="text" name="jumlah" class="input-control" placeholder="Jumlah" required>
...
<div> 
      ...
      <a href="tambah_customer.php?id=<?php echo $row['no_pesanan']?>">
